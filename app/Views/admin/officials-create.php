<div class="mb-4 pb-3 border-bottom">
    ...
    <h2 class="fw-bold text-slate-800 mb-1">Add Elected Official</h2>
    <p class="text-muted small mb-0">Initialize a new leadership registration context for public catalog indexing.</p>
</div>
    ...
    <div class="card-body p-4">
        <form method="POST" action="<?= base_url('admin/officials/create') ?>" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <label class="form-label fw-medium">Profile Directory Photo</label>
                ...
                <div class="col-md-12">
                    <div class="form-check form-switch mt-2">
                        ...
                        <label class="form-check-label fw-medium" for="isActiveSwitch">Publish immediately to official website roster</label>
                    </div>
                </div>
